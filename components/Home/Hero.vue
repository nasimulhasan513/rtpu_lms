<template>
  <div
    class="py-16 bg-gradient-to-r from-primary to-primary-foreground md:max-h-screen"
  >
    <AppContainer>
      <div class="grid items-center grid-cols-1 gap-8 md:grid-cols-2">
        <div class="text-white">
          ...
          <p class="mb-6 text-lg">
            আমাদের অনলাইন শিক্ষা প্ল্যাটফর্মে যোগ দিন এবং আপনার কেরিয়ার
            উন্নয়নের জন্য প্রয়োজনীয় দক্ষতা অর্জন করুন।
          </p>
          <div class="flex space-x-4">
            <Button
              size="lg"
              class="flex items-center gap-2 text-white bg-transparent border border-white rounded-full hover:bg-slate-700"
            >
              আজই যুক্ত হও
