<template>
  <div class="relative group">
    <div
      class="w-24 h-24 overflow-hidden border-4 border-white rounded-full shadow-lg"
    >
      <NuxtImg
        v-if="user.image"
        :src="user.image"
  ...
  <AppModal
    ...
    description="Crop and resize your profile picture"
  ...
  >
    ...
    <div class="flex justify-end gap-3 mt-4">
      <Button variant="destructive" @click="isOpen = false"> Cancel </Button>
