...
<template>
  <header
    class="sticky top-0 z-10 h-[53px] flex items-center gap-4 border-b bg-background px-4 md:px-6 print:hidden"
  >
    <div class="flex items-center w-full gap-4">
      <Sheet>
        ...
        <SheetContent
          aria-describedby="radix-vue-dialog-description-1"
          side="left"
      ...
      <div class="flex items-center gap-4 ml-auto">
        <DropdownMenu>
          ...
          <DropdownMenuContent class="w-56" align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem @click="handleLogout"> লগ আউট </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
    </div>
